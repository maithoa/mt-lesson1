...
function Quiz(props) {
	...
	function showResultSection() {
		return <QuizResult quizResult={props.result} onNext={props.onNext} />;
	}

	function showCountDown() {
		return (
			<Countdown date={Date.now() + 10000} onComplete={props.onTimeOut} />
		);
	}
	...
	return (
		...
		>
			<div key={props.questionId}>
				...
				{typeof props.answerOptions === "undefined" ||
